...
public interface CoreUserMapper
{
     ...
     * @return 用户信息集合信息
     */
    public List<CoreUser> selectUserList(CoreUser CoreUser);
     ...
     * @return 结果
     */
    public CoreUser checkUserNameUnique(String userName);
     ...
     * @return 结果
     */
    public CoreUser checkPhoneUnique(String phonenumber);
     ...
     * @return 结果
     */
    public CoreUser checkEmailUnique(String email);
}
