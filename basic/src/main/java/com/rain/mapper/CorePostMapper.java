 ...
 * @author rain-hechang
 */
public interface CorePostMapper
{
    /**
     * 查询岗位数据集合
     * 
     ...
     * @return 结果
     */
    public List<CorePost> selectPostsByUserName(String userName);
     ...
     * @return 结果
     */
    public CorePost checkPostNameUnique(String postName);
     ...
     * @return 结果
     */
    public CorePost checkPostCodeUnique(String postCode);
}
