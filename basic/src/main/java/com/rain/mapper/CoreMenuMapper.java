...
public interface CoreMenuMapper
{
     ...
     * @return 菜单列表
     */
    public List<CoreMenu> selectMenuList(CoreMenu menu);
     ...
     * @return 菜单列表
     */
    public List<CoreMenu> selectMenuListByUserId(CoreMenu menu);
     ...
     * @return 菜单列表
     */
    public List<CoreMenu> selectMenuTreeAll();
     ...
     * @return 结果
     */
    public CoreMenu checkMenuNameUnique(@Param("menuName") String menuName, @Param("parentId") Long parentId);
}
