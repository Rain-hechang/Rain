...
public class CoreDeptController extends BaseController
{
    private final ICoreDeptService deptService;

    public CoreDeptController(ICoreDeptService deptService) {
    ...
    @GetMapping("/list")
    public AjaxResult list(CoreDept dept)
    {
        List<CoreDept> depts = deptService.selectDeptList(dept);
    ...
    {
        List<CoreDept> depts = deptService.selectDeptList(new CoreDept());
    ...
    @PostMapping
    public AjaxResult add(@Validated @RequestBody CoreDept dept)
    {
    ...
    @PutMapping
    public AjaxResult edit(@Validated @RequestBody CoreDept dept)
    {
