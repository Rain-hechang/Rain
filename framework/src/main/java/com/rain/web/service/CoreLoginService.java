...
import com.rain.exception.user.BlackListException;
import com.rain.exception.user.CaptchaException;
import com.rain.exception.user.CaptchaExpireException;
import com.rain.exception.user.UserNotExistsException;
...
public class CoreLoginService
{
    ...
    public void recordLoginInfo(Long userId)
    {
        ...
        CoreUser.setLoginIp(IpUtils.getIpAddr());
        CoreUser.setLoginDate(DateUtils.getNowDate());
        userService.updateUserProfile(CoreUser);
    }
}
